...
app.use(_config2.default.URL_DOMAIN + "/auth", _IndexRoute.default.authRoute);
app.use(_config2.default.URL_API + "/category", _IndexRoute.default.categoryRoute);
app.use(_config2.default.URL_API + "/product", _IndexRoute.default.productRoute);
app.use(_config2.default.URL_API + "/cart", _IndexRoute.default.cartRoute);
app.use(_config2.default.URL_API + "/order", _IndexRoute.default.orderRoute); //use middleware to handle error from others modules
